import { PrismaClient, Condition, HandoverMethod, OrderStatus, LedgerType } from "@/generated/prisma/client";
...
export async function seedDemoData(db: PrismaClient, log: (msg: string) => void = console.log) {
